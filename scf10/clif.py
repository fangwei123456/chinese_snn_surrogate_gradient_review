...
def main():
    ...
    '''
    python clif.py -data-dir /datasets/CIFAR10 -amp -opt sgd -channels 128 -epochs 256 -out-dir ./templog

    python clif.py -data-dir /datasets/CIFAR10 -amp -opt sgd -channels 128 -epochs 256 -sop -resume /home/wfang/chinese_review/scf10/logs/pt/logs/clif_e256_b128_sgd_lr0.1_c128_amp/checkpoint_max.pth
    '''
