    ...
    def __init__(self, channels, T):
        ...
        for i in range(2):
            for j in range(3):
                ...
                conv.append(PSN(T=T, surrogate_function=surrogate.ATan()))
        ...
        self.fc = nn.Sequential(
            ...
            PSN(T=T, surrogate_function=surrogate.ATan()),
...
def main():
    ...
    python psn.py -data-dir /datasets/CIFAR10 -amp -opt sgd -channels 128 -epochs 256 -device cuda:1


    python psn.py -data-dir /datasets/CIFAR10 -amp -opt sgd -channels 128 -epochs 256 -sop -resume /home/wfang/chinese_review/cf10/logs/pt/logs/psn_T_4_e256_b128_sgd_lr0.1_c128_amp/checkpoint_max.pth
    ...
    net = CIFAR10Net(args.channels, T=args.T)
    net.to(args.device)
