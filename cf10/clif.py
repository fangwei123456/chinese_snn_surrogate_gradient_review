...
def main():
    ...
    python clif.py -data-dir /datasets/CIFAR10 -opt sgd -channels 128 -epochs 256 -out-dir ./templog


    python clif.py -data-dir /datasets/CIFAR10 -amp -opt sgd -channels 128 -epochs 256 -device cuda:1



    python clif.py -data-dir /datasets/CIFAR10 -amp -opt sgd -channels 128 -epochs 256 -sop -resume /home/wfang/chinese_review/cf10/logs/pt/logs/clif_T_4_e256_b128_sgd_lr0.1_c128_amp/checkpoint_max.pth
    ...
    parser.add_argument('-prefix', default='clif', type=str)
